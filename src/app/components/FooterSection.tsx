          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-lg">
                Get the latest resources, updates, and news delivered to your inbox.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button 
                size="lg"
                className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 h-12 px-8"
              >
                Subscribe
              </Button>
            </div>
          ...
          <div className="col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <a href="mailto:hello@cselibrary.com" className="hover:text-foreground transition-colors">
        ...
        <div className="py-8 border-t border-border">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              © 2025 CSELibrary, Inc. All rights reserved.
            </p>
